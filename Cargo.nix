...
args @ {
  ...
  nixifiedLockHash = "6675f57ccbd1fa380e1eccd40cc1f3c64c441e667f15010b75d2c1dbeab65986";
  workspaceSrc =
...
in
  ...
  in {
    ...
    workspace = {
      app-queue = rustPackages.unknown.app-queue."0.1.0";
    };
    ...
    "registry+https://github.com/rust-lang/crates.io-index".ahash."0.8.11" = overridableMkRustCrate (profileName: rec {
      ...
      dependencies = {
        ...
        zerocopy = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".zerocopy."0.7.33" {inherit profileName;}).out;
      };
      buildDependencies = {
    ...
    "unknown".app-queue."0.1.0" = overridableMkRustCrate (profileName: rec {
      name = "app-queue";
      version = "0.1.0";
      registry = "unknown";
    ...
    "registry+https://github.com/rust-lang/crates.io-index".sqlformat."0.2.3" = overridableMkRustCrate (profileName: rec {
      ...
      src = fetchCratesIo {
        inherit name version;
        sha256 = "ce81b7bd7c4493975347ef60d8c7e8b742d4694f4c49f93e0a12ea263938176c";
      };
      dependencies = {
    ...
    "registry+https://github.com/rust-lang/crates.io-index".typetag."0.2.16" = overridableMkRustCrate (profileName: rec {
      ...
      src = fetchCratesIo {
        inherit name version;
        sha256 = "661d18414ec032a49ece2d56eee03636e43c4e8d577047ab334c0ba892e29aaf";
      };
      dependencies = {
    ...
    "registry+https://github.com/rust-lang/crates.io-index".typetag-impl."0.2.16" = overridableMkRustCrate (profileName: rec {
      ...
      src = fetchCratesIo {
        inherit name version;
        sha256 = "ac73887f47b9312552aa90ef477927ff014d63d1920ca8037c6c1951eab64bb1";
      };
      dependencies = {
        proc_macro2 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.81" {inherit profileName;}).out;
        quote = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.36" {inherit profileName;}).out;
    ...
    "registry+https://github.com/rust-lang/crates.io-index".zerocopy."0.7.33" = overridableMkRustCrate (profileName: rec {
      name = "zerocopy";
      version = "0.7.33";
      registry = "registry+https://github.com/rust-lang/crates.io-index";
      src = fetchCratesIo {
        inherit name version;
        sha256 = "087eca3c1eaf8c47b94d02790dd086cd594b912d2043d4de4bfdd466b3befb7c";
      };
      features = builtins.concatLists [
        ["simd"]
      ];
      dependencies = {
        ${
          ...
          (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".zerocopy-derive."0.7.33" {profileName = "__noProfile";}).out;
      };
    });

    "registry+https://github.com/rust-lang/crates.io-index".zerocopy-derive."0.7.33" = overridableMkRustCrate (profileName: rec {
      name = "zerocopy-derive";
      version = "0.7.33";
      registry = "registry+https://github.com/rust-lang/crates.io-index";
      src = fetchCratesIo {
        inherit name version;
        sha256 = "6f4b6c273f496d8fd4eaf18853e6b448760225dc030ff2c485a786859aea6393";
      };
      dependencies = {
        proc_macro2 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.81" {inherit profileName;}).out;
        quote = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.36" {inherit profileName;}).out;
